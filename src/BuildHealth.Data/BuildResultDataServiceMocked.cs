...
namespace BuildHealth.Data
{
    public class BuildResultDataServiceMocked : IBuildResultDataService
    {
        ...
        public BuildResultDataServiceMocked()
        {
            ...
            _mockedDataSet.Add(new BuildResultModel() { Id = 1, ChangelistCutoff = 11, StartTime = now - TimeSpan.FromMinutes(4.23), FinishTime = now - TimeSpan.FromMinutes(0.3), Result = true });
            ...
            _mockedDataSet.Add(new BuildResultModel() { Id = 3, ChangelistCutoff = 24, StartTime = now - TimeSpan.FromMinutes(2.15), FinishTime = now - TimeSpan.FromMinutes(0.069), Result = true });
        }
